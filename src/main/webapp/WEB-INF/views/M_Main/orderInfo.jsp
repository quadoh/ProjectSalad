...
<body>
	...
	<fieldset>
		<form role="form" action="./update" method="post">
			주문번호 :  <input type="text" name="order_num" value="${ovo.order_num }"><br>
			받는사람 이름 : <input type="text" name="name" value="${ovo.order_receive_name }"><br> 
	...
	<script>
		$(document).ready(function() {
			...
			$(".btn-primary").click(function() {
				location.href = "/M_Main/orderDelete?order_num=${ovo.order_num}";
			});
