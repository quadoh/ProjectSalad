...
<div class="lockscreen-wrapper" style="padding-bottom: 350px;">
	...
	<div class="lockscreen-item">
		...
		<div class="lockscreen-image">
			<img src="/resources/dist/img/main_img.jpg" alt="User Image">
		</div>
		<!-- /.lockscreen-image -->
		...
		<form class="lockscreen-credentials">
			<div class="input-group">
				<input type="password" class="form-control" placeholder="  관리자로 로그인해주세요.">
	...
	<div class="text-center">
		<a href="../main">Or Return to SaladMall</a>
	</div>
